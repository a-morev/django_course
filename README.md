...
В части курса "Основы Django Framework" разработана серверная часть для интернет-магазина. Реализованы собственая админка, пользователи, страницы товаров и корзина.
